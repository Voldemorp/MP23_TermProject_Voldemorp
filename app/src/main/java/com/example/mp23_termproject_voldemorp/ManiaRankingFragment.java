...
public class ManiaRankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RankingInfo dummyInfo1 = new RankingInfo(1, "유짐이와농담곰", "디왈리","53");
        RankingInfo dummyInfo2 = new RankingInfo(2, "포켓몬마스터지우", "겐코", "25");
        RankingInfo dummyInfo3 = new RankingInfo(3, "수미칩은맛이있을까", "아이스크림가게","15");
        RankingInfo dummyInfo4 = new RankingInfo(4, "지연은서결혼합니다", "가천컨벤션센터","5");
        RankingInfo dummyInfo5 = new RankingInfo(5, "교수님살려주세요", "AI관413호", "2");
        RankingInfo dummyInfo6 = new RankingInfo(6, "으아아악이건아니야", "죽여라","1");
