...
public class ManiaRankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RankingInfo dummyInfo1 = new RankingInfo("유짐이와농담곰", "행복로드","61");
        RankingInfo dummyInfo2 = new RankingInfo("포켓몬마스터지우", "겐코", "32");
        RankingInfo dummyInfo3 = new RankingInfo("수미칩은맛이있을까", "디왈리","27");
        RankingInfo dummyInfo4 = new RankingInfo("지연은서결혼합니다", "육연차","19");
        RankingInfo dummyInfo5 = new RankingInfo("교수님살려주세요", "1988", "17");
        RankingInfo dummyInfo6 = new RankingInfo("모프에이쁠기원", "쩡이순대국","15");
