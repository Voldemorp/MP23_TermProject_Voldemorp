...
public class MasterRankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RankingInfo dummyInfo1 = new RankingInfo("포켓몬마스터지우", "51");
        RankingInfo dummyInfo2 = new RankingInfo("모프에이쁠기원", "25");
        RankingInfo dummyInfo3 = new RankingInfo("지연은서결혼합니다", "15");
        RankingInfo dummyInfo4 = new RankingInfo("발표잘듣고계신가요", "12");
        RankingInfo dummyInfo5 = new RankingInfo("안종현교수님최고", "9");
        RankingInfo dummyInfo6 = new RankingInfo("고양이귀여워", "5");
